...
{
    public class GitCloneCommandLineTests
    {
        [Test]
        public void NoGitCloneCommandLine_DontOpenRepository()
        {
            ...
            var gitCloneCommandLine = new GitCloneCommandLine(vsAppCommandLine, null, null, vsServices, operatingSystem);
        ...
        public void GitCloneCommandLine_UnknownRepo_DontOpenRepository()
        {
            ...
            var gitCloneCommandLine = new GitCloneCommandLine(vsAppCommandLine, vsGitServices, null, vsServices, operatingSystem);
